...
router.get("/", function (req, res, next) {
  res.render("index", { title: "Learnercentric" });
});
router.get("/about", function (req, res, next) {
  res.render("about", { title: "Learnercentric" });
});
router.get("/contact", function (req, res, next) {
  res.render("contact", { title: "Learnercentric" });
});
router.get("/subjects", function (req, res, next) {
  res.render("subjects", { title: "Learnercentric" });
});
